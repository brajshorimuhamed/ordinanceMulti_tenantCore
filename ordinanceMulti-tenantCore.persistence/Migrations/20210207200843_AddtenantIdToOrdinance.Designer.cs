...
namespace ordinanceMulti_tenantCore.persistence.Migrations
{
    ...
    [Migration("20210207200843_AddtenantIdToOrdinance")]
    partial class AddtenantIdToOrdinance
    {
            ...
            modelBuilder.Entity("ordinanceMulti_tenantCore.domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "12BC2784-B550-5876-98A8-74A621C6E6B8", ConcurrencyStamp = "17270ec8-f9b3-47f9-ae83-120e42ab4f89", Name = "SuperAdmin", NormalizedName = "SuperAdmin" },
                        new { Id = "4FFB4345-CA1C-5050-AB1F-3AE2BE5E46D5", ConcurrencyStamp = "e9da996d-c1dc-4fb7-8fc8-dad7dcec9dce", Name = "Tenant", NormalizedName = "Tenant" }
                    );
                });
            ...
            modelBuilder.Entity("ordinanceMulti_tenantCore.domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "9A6EA564-7238-5CD6-BD64-DA142DD43FF5", AccessFailedCount = 0, ConcurrencyStamp = "3bc0f111-6bea-4539-a647-b9300cdc167f", Email = "muhamedbrajshori@hotmail.com", EmailConfirmed = true, FirstName = "Muhamed", LastName = "Brajshori", LockoutEnabled = false, NormalizedEmail = "muhamedbrajshori@hotmail.com", NormalizedUserName = "muhamedbrajshori@hotmail.com", PasswordHash = "AQAAAAEAACcQAAAAEOqHkWnJP/ubhweK8dCKZ+3b0E/3P0Q1gd3LcLDZoHamAduJL2fmHdEBW2aZ5d7l3w==", PhoneNumber = "+38344224106", PhoneNumberConfirmed = true, SecurityStamp = "1acf80e3-80f3-4385-a9e0-e25cd3c2d300", TwoFactorEnabled = false, UserName = "muhamedbrajshori@hotmail.com" }
                    );
                });
